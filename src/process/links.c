/**
 * @file links.c
 * @brief Implémentation des fonctions de gestion des liens symboliques et physiques
 * @author Massin KHELOUFI (100%)
 * 
 * Ce fichier contient l'implémentation des fonctions permettant de gérer
 * les liens dans le système de fichiers, notamment :
 * - La création de liens symboliques
 * - La création de liens physiques (hard links)
 * - La lecture des liens symboliques
 */
  ...
  * 
  * Cette fonction crée un nouveau lien symbolique pointant vers une cible.
  * Le lien symbolique est stocké comme un fichier spécial contenant le chemin
  * de la cible. Les liens symboliques peuvent pointer vers des fichiers ou
  * des répertoires, même s'ils n'existent pas encore.
  *
  * @param linkName Nom du lien symbolique à créer
  * @param targetPath Chemin de la cible du lien
  * @param dirID ID du répertoire où créer le lien
 ...
 /**
  * @brief Crée un lien physique vers un fichier
  * 
  * Cette fonction crée un nouveau lien physique (hard link) vers un fichier existant.
  * Le lien physique partage le même bloc de données que le fichier cible et pointe
  * vers le même inode. Les liens physiques ne peuvent pointer que vers des fichiers,
  * pas des répertoires.
  *
  * @param linkName Nom du lien physique à créer
  * @param targetFile Nom du fichier cible
  * @param dirID ID du répertoire où créer le lien
  * @return 0 en cas de succès, -1 en cas d'erreur
  */
  ...
  * 
  * Cette fonction lit et retourne le chemin cible d'un lien symbolique.
  * Elle ne suit pas le lien, elle retourne simplement le chemin stocké
  * dans le lien symbolique.
  *
  * @param linkName Nom du lien symbolique à lire
  * @param dirID ID du répertoire contenant le lien
  * @return Le chemin cible du lien ou NULL en cas d'erreur
  * @note Le appelant doit libérer la mémoire du chemin retourné
  */
